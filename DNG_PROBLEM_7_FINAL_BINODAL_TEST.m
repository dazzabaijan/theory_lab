...
title('The bulk phase diagram with a high density initial guess(\rho_0 = 0.9999)','FontSize', 15)

subplot(3,1,2)
pcolor(mu, 1./beta, app_mid); shading interp;

xlabel('\mu/\epsilon','FontSize', 18); ylabel('k_{B}T/\epsilon','FontSize', 18);
title('The bulk phase diagram with a equal density initial guess(\rho_0 = 0.5)','FontSize', 15)

subplot(3,1,3)
pcolor(mu, 1./beta, app_low); shading interp;

xlabel('\mu/\epsilon','FontSize', 18); ylabel('k_{B}T/\epsilon','FontSize', 18);
title('The bulk phase diagram with a low density initial guess(\rho_0 = 0.0001)','FontSize', 15)
...
legend(h, 'Spinodal','Binodal','T_{c} = 1.25');
hold off;
